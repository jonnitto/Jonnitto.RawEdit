...
* Create an [issue](https://github.com/jonnitto/Jonnitto.RawEdit/issues) on GitHub, if you have found a bug
...
* Submit an [issue](https://github.com/jonnitto/Jonnitto.RawEdit/issues), assuming one does not already exist.
